 ...
 */
package com.example.dbsdn.mychat.liveVideoPlayer.flvExtractor;
...
public final class FlvExtractor implements Extractor, SeekMap {
  ...
  public static final ExtractorsFactory FACTORY = new ExtractorsFactory() {
    ...
    public Extractor[] createExtractors() {
      return new Extractor[] {new com.example.dbsdn.mychat.liveVideoPlayer.flvExtractor.FlvExtractor()};
//.dbsdn.Mychat.liveVideoPlayer.flvExtractor.FlvExtractor()
    }
